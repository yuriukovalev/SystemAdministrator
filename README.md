...
администрировании инфраструктуры: управление Active Directory, мониторинг и
обслуживание серверов, автоматизация через Ansible, настройка сети на MikroTik
и обслуживание Proxmox.
